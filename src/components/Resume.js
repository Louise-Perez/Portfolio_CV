            ...
            <div className={style.resumeBody}>
                <Grid  className={style.resumeGrid}>
                    <Cell col={4} className={style.resume}>
                        ...
                        <h4> Developpeuse Web Junior </h4>
                        <hr className={style.separator}/>
                        <p className={style.introduction}> Issue d'une <strong>formation communication</strong>, 
                        j'ai toujours été attirée par les nouvelles technologies, je suis actuellement en <strong>reconversion </strong> dans le développement web au sein de l'Adrar Formation à Montpellier.
                        <br/>A côté du développement web, je pratique l'escalade depuis plus de 12 ans, 
